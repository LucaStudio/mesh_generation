...
if any(periodicity==1) && any(periodicity==2) && any(periodicity==3)
    structuralneighbours(indicesE1,:)   = [4*ones(length(indicesE1),1)  indicesE1-1            indicesE1+1            indicesE1+(Ny-1)*Nx    indicesE1+Nx           indicesE1+(Nz-1)*Nx*Ny    indicesE1+Nx*Ny      ];
    structuralneighbours(indicesE2,:)   = [4*ones(length(indicesE2),1)  indicesE2-1            indicesE2-(Nx-1)       indicesE2-Nx           indicesE2+Nx           indicesE2+(Nz-1)*Nx*Ny    indicesE2+Nx*Ny      ];
    structuralneighbours(indicesE3,:)   = [4*ones(length(indicesE3),1)  indicesE3-1            indicesE3+1            indicesE3-Nx           indicesE3-(Ny-1)*Nx    indicesE3+(Nz-1)*Nx*Ny    indicesE3+Nx*Ny      ];
    structuralneighbours(indicesE4,:)   = [4*ones(length(indicesE4),1)  indicesE4+(Nx-1)       indicesE4+1            indicesE4-Nx           indicesE4+Nx           indicesE4+(Nz-1)*Nx*Ny    indicesE4+Nx*Ny      ];
    structuralneighbours(indicesE5,:)   = [4*ones(length(indicesE5),1)  indicesE5+(Nx-1)       indicesE5+1            indicesE5+(Ny-1)*Nx    indicesE5+Nx           indicesE5-Nx*Ny           indicesE5+Nx*Ny      ];
    structuralneighbours(indicesE6,:)   = [4*ones(length(indicesE6),1)  indicesE6-1            indicesE6-(Nx-1)       indicesE6+(Ny-1)*Nx    indicesE6+Nx           indicesE6-Nx*Ny           indicesE6+Nx*Ny      ];
    structuralneighbours(indicesE7,:)   = [4*ones(length(indicesE7),1)  indicesE7-1            indicesE7-(Nx-1)       indicesE7-Nx           indicesE7-(Ny-1)*Nx    indicesE7-Nx*Ny           indicesE7+Nx*Ny      ];
    structuralneighbours(indicesE8,:)   = [4*ones(length(indicesE8),1)  indicesE8+(Nx-1)       indicesE8+1            indicesE8-Nx           indicesE8-(Ny-1)*Nx    indicesE8-Nx*Ny           indicesE8+Nx*Ny      ];
    structuralneighbours(indicesE9,:)   = [4*ones(length(indicesE9),1)  indicesE9-1            indicesE9+1            indicesE9+(Ny-1)*Nx    indicesE9+Nx           indicesE9-Nx*Ny           indicesE9-(Nz-1)*Nx*Ny ];
    structuralneighbours(indicesE10,:)  = [4*ones(length(indicesE10),1) indicesE10-1           indicesE10-(Nx-1)      indicesE10-Nx          indicesE10+Nx          indicesE10-Nx*Ny          indicesE10-(Nz-1)*Nx*Ny];
    structuralneighbours(indicesE11,:)  = [4*ones(length(indicesE11),1) indicesE11-1           indicesE11+1           indicesE11-Nx          indicesE11-(Ny-1)*Nx   indicesE11-Nx*Ny          indicesE11-(Nz-1)*Nx*Ny];
    structuralneighbours(indicesE12,:)  = [4*ones(length(indicesE12),1) indicesE12+(Nx-1)      indicesE12+1           indicesE12-Nx          indicesE12+Nx          indicesE12-Nx*Ny          indicesE12-(Nz-1)*Nx*Ny];
                    
    structuralneighbours(indicesC1,:)   = [3*ones(length(indicesC1),1)  indicesC1+(Nx-1)       indicesC1+1            indicesC1+(Ny-1)*Nx    indicesC1+Nx           indicesC1+(Nz-1)*Nx*Ny    indicesC1+Nx*Ny      ];
    structuralneighbours(indicesC2,:)   = [3*ones(length(indicesC2),1)  indicesC2-1            indicesC2-(Nx-1)       indicesC2+(Ny-1)*Nx    indicesC2+Nx           indicesC2+(Nz-1)*Nx*Ny    indicesC2+Nx*Ny      ];
    structuralneighbours(indicesC3,:)   = [3*ones(length(indicesC3),1)  indicesC3-1            indicesC3-(Nx-1)       indicesC3-Nx           indicesC3-(Ny-1)*Nx    indicesC3+(Nz-1)*Nx*Ny    indicesC3+Nx*Ny      ];
    structuralneighbours(indicesC4,:)   = [3*ones(length(indicesC4),1)  indicesC4+(Nx-1)       indicesC4+1            indicesC4-Nx           indicesC4-(Ny-1)*Nx    indicesC4+(Nz-1)*Nx*Ny    indicesC4+Nx*Ny      ];
    structuralneighbours(indicesC5,:)   = [3*ones(length(indicesC5),1)  indicesC5+(Nx-1)       indicesC5+1            indicesC5+(Ny-1)*Nx    indicesC5+Nx           indicesC5-Nx*Ny           indicesC5-(Nz-1)*Nx*Ny ];
    structuralneighbours(indicesC6,:)   = [3*ones(length(indicesC6),1)  indicesC6-1            indicesC6-(Nx-1)       indicesC6+(Ny-1)*Nx    indicesC6+Nx           indicesC6-Nx*Ny           indicesC6-(Nz-1)*Nx*Ny ];
    structuralneighbours(indicesC7,:)   = [3*ones(length(indicesC7),1)  indicesC7-1            indicesC7-(Nx-1)       indicesC7-Nx           indicesC7-(Ny-1)*Nx    indicesC7-Nx*Ny           indicesC7-(Nz-1)*Nx*Ny ];
    structuralneighbours(indicesC8,:)   = [3*ones(length(indicesC8),1)  indicesC8+(Nx-1)       indicesC8+1            indicesC8-Nx           indicesC8-(Ny-1)*Nx    indicesC8-Nx*Ny           indicesC8-(Nz-1)*Nx*Ny ];
else
