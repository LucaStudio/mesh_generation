function[ellipse]=ellipticalsection2D(a,b,x0,y0,Neta1,Neta2,eta1min,eta1max,eta2min,eta2max,deltaeta1,deltaeta2,xmin,xmax,Nx,ymin,ymax,Ny)
...
ellipse = transfiniteinterpolation2D(Neta1*Neta2,lattice(:,1:2),eta1min,eta1max,eta2min,eta2max,Neta1,Neta2,1,e1,e2,e3,e4,c1,c2,c3,c4);
