...
latticeupper = transfiniteinterpolation2D(N,latticeupper(:,1:2),eta1min,eta1max,eta2min,eta2max,Neta1,Neta2,1,e1,e2,e3,e4,c1,c2,c3,c4);
...
latticelower = transfiniteinterpolation2D(N,latticelower(:,1:2),eta1min,eta1max,eta2min,eta2max,Neta1,Neta2,1,e1,e2,e3,e4,c1,c2,c3,c4);
