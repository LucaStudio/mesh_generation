...
@function
def gmresmprecond(A=None,b=None,invM=None,x0=None,m=None,tol=None,maxrestart=None,*args,**kwargs):
    varargin = gmresmprecond.varargin
    nargin = gmresmprecond.nargin
