...
@function
def gmresmprecondfunchandle(fAx=None,b=None,finvMx=None,x0=None,m=None,tol=None,maxrestart=None,*args,**kwargs):
    varargin = gmresmprecondfunchandle.varargin
    nargin = gmresmprecondfunchandle.nargin
