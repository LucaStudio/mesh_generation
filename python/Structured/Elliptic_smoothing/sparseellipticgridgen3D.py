...
#         Output: mesh in the physical domain
    ...
    boundaryindices=matlabarray(cat([indicesF1],[indicesF2],[indicesF3],[indicesF4],[indicesF5],[indicesF6],[indicesE1],[indicesE2],[indicesE3],[indicesE4],[indicesE5],[indicesE6],[indicesE7],[indicesE8],[indicesE9],[indicesE10],[indicesE11],[indicesE12],[indicesC1],[indicesC2],[indicesC3],[indicesC4],[indicesC5],[indicesC6],[indicesC7],[indicesC8]))
    it=0
    err=1
    if spyflag:
