...
##
    ...
    xval=(arange((x0 - (Lx + 0)),(x0 + (Lx + 0)),(dot(2,Lx)) / 100)).T
    yval=(arange((y0 - (Ly + 0)),(y0 + (Ly + 0)),(dot(2,Ly)) / 100)).T
    X,Y=meshgrid(xval,yval,nargout=2)
    ...
    omegaminus=dot(0.5,(abs(omega) - omega))
    Fxomega,Fyomega=gradient(omega,(dot(2,Lx)) / 100,(dot(2,Ly)) / 100,nargout=2)
    Fxomegaminus,Fyomegaminus=gradient(omegaminus,(dot(2,Lx)) / 100,(dot(2,Ly)) / 100,nargout=2)
    f1=copy(figure)
