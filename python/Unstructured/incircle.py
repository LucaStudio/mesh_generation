...
@function
def incircle(a=None,b=None,c=None,d=None,*args,**kwargs):
    varargin = incircle.varargin
    nargin = incircle.nargin
...
##
    ...
    e=sign(det(cat([a[1,1] - d[1,1],a[2,1] - d[2,1],(a[1,1] - d[1,1]) ** 2 + (a[2,1] - d[2,1]) ** 2],[b[1,1] - d[1,1],b[2,1] - d[2,1],(b[1,1] - d[1,1]) ** 2 + (b[2,1] - d[2,1]) ** 2],[c[1,1] - d[1,1],c[2,1] - d[2,1],(c[1,1] - d[1,1]) ** 2 + (c[2,1] - d[2,1]) ** 2])))
    return e