...
@function
def insphere(a=None,b=None,c=None,d=None,e=None,*args,**kwargs):
    varargin = insphere.varargin
    nargin = insphere.nargin
...
##
    ...
    f=sign(det(cat([a[1,1] - e[1,1],a[2,1] - e[2,1],a[3,1] - e[3,1],(a[1,1] - e[1,1]) ** 2 + (a[2,1] - e[2,1]) ** 2 + (a[3,1] - e[3,1]) ** 2],[b[1,1] - e[1,1],b[2,1] - e[2,1],b[3,1] - e[3,1],(b[1,1] - e[1,1]) ** 2 + (b[2,1] - e[2,1]) ** 2 + (b[3,1] - e[3,1]) ** 2],[b[1,1] - e[1,1],c[2,1] - e[2,1],c[3,1] - e[3,1],(c[1,1] - e[1,1]) ** 2 + (c[2,1] - e[2,1]) ** 2 + (c[3,1] - e[3,1]) ** 2],[d[1,1] - e[1,1],d[2,1] - e[2,1],d[3,1] - e[3,1],(d[1,1] - e[1,1]) ** 2 + (d[2,1] - e[2,1]) ** 2 + (d[3,1] - e[3,1]) ** 2])))
    return f