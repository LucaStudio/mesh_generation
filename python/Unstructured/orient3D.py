...
@function
def orient3D(a=None,b=None,c=None,d=None,*args,**kwargs):
    varargin = orient3D.varargin
    nargin = orient3D.nargin
...
##
    ...
    e=det(cat([a[1,1] - d[1,1],a[2,1] - d[2,1],a[3,1] - d[3,1]],[b[1,1] - d[1,1],b[2,1] - d[2,1],b[3,1] - d[3,1]],[c[1,1] - d[1,1],c[2,1] - d[2,1],c[3,1] - d[3,1]]))
    return e